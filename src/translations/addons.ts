export const addOnsTranslations = {
  'addons.pageTitle': {
    sv: 'Tillägg för alla behov',
    en: 'Add-ons for all needs'
  },
  'addons.subtitle': {
    sv: 'Utöka Lucy med kraftfulla tillägg som passar din verksamhets specifika behov.',
  ...
  'addons.surveys.title': {
    sv: 'Employee & Pulse Surveys',
    en: 'Employee & Pulse Surveys'
  },
  'addons.surveys.description': {
    sv: 'Genomför anonyma medarbetarundersökningar och få professionella rapporter per avdelning och företagsövergripande. Hotell kan också få tillgång till ett dedikerat branschbenchmark.',
    en: 'Run anonymous employee surveys and receive professional reports by department and company-wide. Hotels can also access a dedicated industry benchmark for comparison.'
  },
  'addons.customAI.title': {
    sv: 'Custom AI Agent',
    en: 'Custom AI Agent'
  },
  ...
  'addons.dailyFeed.description': {
    sv: 'Leverera dagliga uppdateringar till utvalda teammedlemmar — såsom skiftrapporter, arbetsorder, försäljningssiffror och att-göra-listor — inklusive extern data via API.',
