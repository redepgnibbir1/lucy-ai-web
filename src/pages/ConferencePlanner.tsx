...
const ConferencePlanner = () => {
  ...
  const results = [
    { icon: Clock, titleKey: 'cp.results.time.title', descKey: 'cp.results.time.description' },
    { icon: TrendingDown, titleKey: 'cp.results.errors.title', descKey: 'cp.results.errors.description' },
    { icon: Handshake, titleKey: 'cp.results.dialogue.title', descKey: 'cp.results.dialogue.description' },
    { icon: TrendingUp, titleKey: 'cp.results.upsell.title', descKey: 'cp.results.upsell.description' }
  ];

  const audiences = [
    { icon: Building, titleKey: 'cp.audience.venues.title', descKey: 'cp.audience.venues.description' },
    { icon: Hotel, titleKey: 'cp.audience.hotels.title', descKey: 'cp.audience.hotels.description' },
    { icon: CalendarDays, titleKey: 'cp.audience.agencies.title', descKey: 'cp.audience.agencies.description' },
    { icon: Users, titleKey: 'cp.audience.companies.title', descKey: 'cp.audience.companies.description' }
  ];
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-wrap gap-4 justify-center">
                ...
                <Button 
                  ...
                  variant="outline"
                  className="border-lucy-black text-lucy-black hover:bg-lucy-black hover:text-white font-sans text-lg px-8 py-6"
                >
                  {t('cp.hero.cta.how')}
                </Button>
              </motion.div>
      ...
      <section className="py-20 lg:py-32 bg-gray-50">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <motion.p 
              variants={fadeInUp}
              className="font-sans text-lg text-gray-600 mb-12"
            >
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <motion.p 
                variants={fadeInUp}
                className="font-sans text-lg text-gray-600 mb-8"
              >
              ...
              <div className="bg-white rounded-lg border border-gray-300 overflow-hidden">
                ...
                <div className="p-4 space-y-2 font-mono text-sm text-gray-600">
                  <div className="grid grid-cols-3 gap-2">
                    <div className="bg-gray-50 p-2 border">Tillägg A</div>
                    <div className="bg-gray-50 p-2 border">500 kr</div>
                    <div className="bg-gray-50 p-2 border">Ja/Nej</div>
                  </div>
                  <div className="grid grid-cols-3 gap-2">
                    <div className="bg-gray-50 p-2 border">Tillägg B</div>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button 
                ...
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-lucy-black font-sans text-lg px-8 py-6"
              >
                {t('cp.cta.contact')}
              </Button>
            </div>
